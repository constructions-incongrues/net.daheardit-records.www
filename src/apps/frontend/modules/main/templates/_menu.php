      ...
      <div class="grid_12 header_nav_3">
        <div class="header_nav_3_content">
          <ul id="menu-main" class="header_nav_3_content_list">
            ...
            <li><a href="#artwork_artists"><?php echo __('Illustrateurs') ?></a></li>
            ...
            <li class="header_nav_3_button_donate donate_infos"><a href="https://www.helloasso.com/associations/constructions-incongrues/formulaires/1" class="donate">&hearts; <?php echo __('Dons') ?> &hearts;

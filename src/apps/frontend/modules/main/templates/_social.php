...
<?php endif; ?>
	<li><a href="http://www.facebook.com/dahearditrecords"><img src="<?php echo $sf_request->getRelativeUrlRoot() ?>/frontend/pics/icon/img-facebook-w.png" alt="facebook"/></a></li>
	<li><a href="http://twitter.com/daheardit"><img src="<?php echo $sf_request->getRelativeUrlRoot() ?>/frontend/pics/icon/img-twitter-w.png" alt="twitter"/></a></li>

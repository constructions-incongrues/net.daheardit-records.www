...
<div class="presentation">
      ...
      <span class="sku">
        <?php echo $release['sku'] ?> /
        <?php echo $release['released_at'] ?> /
        <a href="https://creativecommons.org/licenses/by-nc-nd/4.0/">CC BY-NC-ND 4.0</a>
      <span>
      <h2 class="open_releases_artist">

<a href="<?php echo url_for(sprintf('@artist_show?slug=%s#artist', $release['Artist']['slug'])) ?>"><br /><?php echo $release['Artist']['name'] ?></a>  <?php echo $release['title'] ?> 
</h2>

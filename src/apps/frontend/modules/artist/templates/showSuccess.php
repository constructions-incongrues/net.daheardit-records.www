...
<?php endif; ?>
  ...
  <div class="presentation">
    ...
    <img height="30%" width="30%" style="float:right;margin-top:50px;" src="<?php echo $sf_request->getRelativeUrlRoot() ?>/assets/artists/<?php echo $artist['slug'] ?>/<?php echo $artist['slug'] ?>_300x300.jpg" alt="" /> 
    <p class="text-bio">

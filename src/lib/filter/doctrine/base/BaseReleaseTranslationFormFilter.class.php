...
/**
 * ReleaseTranslation filter form base class.
 *
 ...
 */
abstract class BaseReleaseTranslationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('release_translation_filters[%s]');

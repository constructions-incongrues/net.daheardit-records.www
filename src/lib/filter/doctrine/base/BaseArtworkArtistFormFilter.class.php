...
/**
 * ArtworkArtist filter form base class.
 *
 ...
 */
abstract class BaseArtworkArtistFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('artwork_artist_filters[%s]');

...
/**
 * ArtistTranslation filter form base class.
 *
 ...
 */
abstract class BaseArtistTranslationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('artist_translation_filters[%s]');
